  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="w-full max-w-md">
        ...
        {/* Auth Card */}
        <Card className="shadow-2xl border-emerald-100 dark:border-emerald-900">
          ...
          <CardContent className="space-y-6">
            ...
            <form action={handleGoogleSignIn}>
              <Button
                type="submit"
                variant="outline"
                className="w-full h-12 text-base border-2 hover:border-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-950 transition-all"
              >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                    Your data is protected with industry-standard OAuth 2.0 security. We never see or store your Google password.
                  </p>
                </div>
              </div>
            </div>
