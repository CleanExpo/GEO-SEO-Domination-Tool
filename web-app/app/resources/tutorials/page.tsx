...
export default function TutorialsPage() {
  const [tutorials, setTutorials] = useState<Tutorial[]>([
    {
      id: '1',
      title: 'Complete SEO Fundamentals',
      description: 'Master the basics of search engine optimization from keyword research to on-page optimization',
      category: 'SEO Basics',
      duration: '4.5 hours',
      difficulty: 'beginner',
      completionRate: 0,
    ...
    },
    {
      ...
      description: 'Deep dive into technical SEO including site structure, crawling, indexing, and performance',
    ...
    },
    {
      ...
      description: 'Learn how to dominate local search results and optimize Google Business Profile',
      category: 'Local SEO',
      duration: '3 hours',
    ...
    },
    {
      ...
      description: 'Create SEO-optimized content that ranks and converts with proven strategies',
      category: 'Content',
      duration: '5 hours',
      difficulty: 'intermediate',
      completionRate: 60,
