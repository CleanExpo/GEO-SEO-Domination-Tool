        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 z-10 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/30 hover:shadow-xl hover:shadow-emerald-600/40 hover:-translate-y-0.5"
              >
                Try it now
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold hover:shadow-lg transition-all border-2 border-gray-200 hover:border-emerald-200"
              >
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-6 sm:pt-8">
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">50K+</div>
                <div className="text-xs sm:text-sm text-gray-600 mt-1">SEO Audits</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">1M+</div>
                <div className="text-xs sm:text-sm text-gray-600 mt-1">Keywords Tracked</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">99.9%</div>
                <div className="text-xs sm:text-sm text-gray-600 mt-1">Uptime</div>
              </div>
            </div>
          </div>

          {/* Right: Floating Screenshot Showcase */}
          <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] order-1 lg:order-2">
            {/* Rankings Card - Top Left */}
            <div className="absolute top-0 left-0 w-40 sm:w-48 lg:w-56 transform-gpu hover:scale-105 transition-all duration-500 z-20 floating-card">
              <div className="relative group">
                <div className="absolute inset-0 bg-emerald-400 rounded-lg blur-lg opacity-15 group-hover:opacity-30 transition-opacity"></div>
                <div className="relative bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                  <div className="p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600" />
                      <span className="font-semibold text-gray-900 text-xs sm:text-sm">Rankings</span>
                    </div>
                    <div className="space-y-1.5 sm:space-y-2">
                      <div className="flex justify-between items-center p-1.5 sm:p-2 bg-emerald-50 rounded text-xs">
                        <span className="text-gray-700">Position 1</span>
                        <span className="text-emerald-600 font-bold">#1</span>
                      </div>
                      <div className="flex justify-between items-center p-1.5 sm:p-2 bg-blue-50 rounded text-xs">
                        <span className="text-gray-700">Position 2</span>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-blue-500 via-purple-500 to-purple-600 rounded-xl shadow-2xl overflow-hidden border-2 border-white/70">
                  <div className="p-4 sm:p-6 text-center text-white">
                    <BarChart3 className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-2 sm:mb-3 opacity-90" />
                    <h3 className="text-lg sm:text-2xl font-bold mb-1 sm:mb-2">Analytics Dashboard</h3>
                    <p className="text-blue-100 text-xs sm:text-sm">Real-time SEO insights</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-4 sm:top-8 right-0 w-36 sm:w-44 lg:w-52 transform-gpu hover:scale-105 transition-all duration-500 z-20 floating-card-delayed-2">
              <div className="relative group">
                <div className="absolute inset-0 bg-teal-400 rounded-lg blur-lg opacity-15 group-hover:opacity-30 transition-opacity"></div>
                <div className="relative bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg shadow-lg overflow-hidden border-2 border-white p-3 sm:p-4 text-white">
                  <Search className="w-5 h-5 sm:w-6 sm:h-6 mb-1 sm:mb-2" />
                  <div className="text-2xl sm:text-3xl font-bold mb-0.5 sm:mb-1">2,847</div>
                  <div className="text-emerald-100 text-xs font-medium">Active Keywords</div>
                  <div className="mt-1 sm:mt-2 flex items-center gap-1 text-emerald-200 text-xs">
                ...
                <div className="relative bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                  <div className="p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-gray-900 text-xs sm:text-sm">Company C</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="absolute bottom-0 sm:bottom-4 right-4 sm:right-8 w-40 sm:w-48 lg:w-56 transform-gpu hover:scale-105 transition-all duration-500 z-10 floating-card">
              <div className="relative group">
                <div className="absolute inset-0 bg-pink-400 rounded-lg blur-lg opacity-15 group-hover:opacity-30 transition-opacity"></div>
                <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 rounded-lg shadow-lg overflow-hidden border-2 border-white p-3 sm:p-4 text-white">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 mb-1 sm:mb-2" />
                  <div className="text-sm sm:text-base font-bold mb-0.5">In 2 hours</div>
                  <div className="text-pink-100 text-xs">Auto-scheduled</div>
                </div>
              </div>
            </div>

            {/* Background Glow Effects */}
            <div className="absolute top-1/4 right-0 w-64 sm:w-80 lg:w-96 h-64 sm:h-80 lg:h-96 bg-emerald-300 rounded-full opacity-10 blur-3xl pointer-events-none"></div>
            <div className="absolute bottom-1/4 left-0 w-56 sm:w-72 lg:w-80 h-56 sm:h-72 lg:h-80 bg-blue-400 rounded-full opacity-10 blur-3xl pointer-events-none"></div>
          </div>
        </div>
      </div>
