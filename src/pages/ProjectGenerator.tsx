...
export default function ProjectGenerator() {
  ...
  const templates: ProjectTemplate[] = [
    {
      ...
      integrations: ['shadcn', 'semrush-mcp', 'github-mcp', 'vercel-mcp', 'playwright-mcp', 'supabase', 'github', 'vercel', 'openai', 'anthropic', 'firecrawl'],
    },
    {
      id: 'nextjs-app',
      ...
      integrations: ['shadcn', 'semrush-mcp', 'github-mcp', 'vercel-mcp', 'playwright-mcp', 'supabase', 'github', 'vercel', 'stripe', 'openai', 'firecrawl'],
    },
    {
      id: 'fastapi-python',
  ...
  const availableIntegrations = [
    ...
    { id: 'playwright-mcp', name: 'Playwright MCP', icon: '🎭', description: 'Browser automation via AI' },
